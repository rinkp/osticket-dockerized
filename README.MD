...
When using the local database instance, note that the first start will take an extra 30 seconds since MariaDB has to start.<br/>
...
## Noteworthy changes
Tags containing `-patches` are built from a fork of osTicket: https://github.com/rinkp/osticket-dockerized. Updates are rebased from the original to allow for easy comparisons. See the changes for 1.18.4 [here](https://github.com/osTicket/osTicket/compare/v1.18.4...rinkp:osTicket:v1.18.4-patches)
...
- Current changes:
  - Allow certain forms to be visited when anonymous ticket creation is disabled (https://github.com/rinkp/osTicket/commit/cee0191cc5885aecfcce5b7c23d7e4cc021bb0a1) by specifying a topic ID: `/open.php?topicId=1`
  - Enable SSL during setup (by @tomudding in https://github.com/rinkp/osTicket/commit/50d19ac15e3c63c1b09858b92e7a3638022dc3bc)