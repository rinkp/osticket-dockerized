...
## Noteworthy changes
Tags containing `-patches` are built from a fork of osTicket: https://github.com/rinkp/osticket-dockerized. Updates are rebased from the original to allow for easy comparisons. See the changes for 1.18.2 [here](https://github.com/osTicket/osTicket/compare/v1.18.3...rinkp:osTicket:v1.18.3-patches)
